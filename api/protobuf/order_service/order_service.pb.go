...
func (x *UpdateOrderStatusRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AssignDriverRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *CompleteDeliveryRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetDeliveriesByUserRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetDeliveriesByUserRequest) Reset() {
	*x = GetDeliveriesByUserRequest{}
	mi := &file_order_service_order_service_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDeliveriesByUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDeliveriesByUserRequest) ProtoMessage() {}

func (x *GetDeliveriesByUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_order_service_order_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDeliveriesByUserRequest.ProtoReflect.Descriptor instead.
func (*GetDeliveriesByUserRequest) Descriptor() ([]byte, []int) {
	return file_order_service_order_service_proto_rawDescGZIP(), []int{16}
}

func (x *GetDeliveriesByUserRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetDeliveriesByUserResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Deliveries    []*Order               `protobuf:"bytes,1,rep,name=deliveries,proto3" json:"deliveries,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetDeliveriesByUserResponse) Reset() {
	*x = GetDeliveriesByUserResponse{}
	mi := &file_order_service_order_service_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetDeliveriesByUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDeliveriesByUserResponse) ProtoMessage() {}

func (x *GetDeliveriesByUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_service_order_service_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDeliveriesByUserResponse.ProtoReflect.Descriptor instead.
func (*GetDeliveriesByUserResponse) Descriptor() ([]byte, []int) {
	return file_order_service_order_service_proto_rawDescGZIP(), []int{17}
}

func (x *GetDeliveriesByUserResponse) GetDeliveries() []*Order {
	if x != nil {
		return x.Deliveries
	}
	return nil
...
const file_order_service_order_service_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x19\n" +
	"\border_id\x18\x02 \x01(\x03R\aorderId\"\x82\x01\n" +
	...
	"\tdriver_id\x18\b \x01(\x03R\bdriverId\"\xbb\x01\n" +
	"\tOrderItem\x12\x19\n" +
	...
	"totalPrice\"5\n" +
	"\x1aGetDeliveriesByUserRequest\x12\x17\n" +
	...
	"\x11GetOrderItemPrice\x12\x1f.order.GetOrderItemPriceRequest\x1a .order.GetOrderItemPriceResponseB\bZ\x06/orderb\x06proto3"
...
var file_order_service_order_service_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_order_service_order_service_proto_goTypes = []any{
	...
	(*GetOrderItemPriceRequest)(nil),    // 7: order.GetOrderItemPriceRequest
	(*GetOrderItemPriceResponse)(nil),   // 8: order.GetOrderItemPriceResponse
	(*GetOrderDetailsResponse)(nil),     // 9: order.GetOrderDetailsResponse
	(*CompleteDeliveryRequest)(nil),     // 10: order.CompleteDeliveryRequest
	(*CompleteDeliveryResponse)(nil),    // 11: order.CompleteDeliveryResponse
	(*GetOrdersByUserRequest)(nil),      // 12: order.GetOrdersByUserRequest
	(*GetOrdersByUserResponse)(nil),     // 13: order.GetOrdersByUserResponse
	(*Order)(nil),                       // 14: order.Order
	(*OrderItem)(nil),                   // 15: order.OrderItem
	(*GetDeliveriesByUserRequest)(nil),  // 16: order.GetDeliveriesByUserRequest
	(*GetDeliveriesByUserResponse)(nil), // 17: order.GetDeliveriesByUserResponse
	(*timestamppb.Timestamp)(nil),       // 18: google.protobuf.Timestamp
}
var file_order_service_order_service_proto_depIdxs = []int32{
	15, // 0: order.CreateOrderRequest.items:type_name -> order.OrderItem
	14, // 1: order.CreateOrderResponse.order:type_name -> order.Order
	14, // 2: order.GetOrderDetailsResponse.order:type_name -> order.Order
	14, // 3: order.GetOrdersByUserResponse.orders:type_name -> order.Order
	15, // 4: order.Order.items:type_name -> order.OrderItem
	18, // 5: order.Order.created_at:type_name -> google.protobuf.Timestamp
	14, // 6: order.GetDeliveriesByUserResponse.deliveries:type_name -> order.Order
	0,  // 7: order.OrderService.CreateOrder:input_type -> order.CreateOrderRequest
	2,  // 8: order.OrderService.UpdateOrderStatus:input_type -> order.UpdateOrderStatusRequest
	4,  // 9: order.OrderService.AssignDriver:input_type -> order.AssignDriverRequest
	6,  // 10: order.OrderService.GetOrderDetails:input_type -> order.GetOrderDetailsRequest
	12, // 11: order.OrderService.GetOrdersByUser:input_type -> order.GetOrdersByUserRequest
	10, // 12: order.OrderService.CompleteDelivery:input_type -> order.CompleteDeliveryRequest
	16, // 13: order.OrderService.GetDeliveries:input_type -> order.GetDeliveriesByUserRequest
	7,  // 14: order.OrderService.GetOrderItemPrice:input_type -> order.GetOrderItemPriceRequest
	1,  // 15: order.OrderService.CreateOrder:output_type -> order.CreateOrderResponse
	3,  // 16: order.OrderService.UpdateOrderStatus:output_type -> order.UpdateOrderStatusResponse
	5,  // 17: order.OrderService.AssignDriver:output_type -> order.AssignDriverResponse
	9,  // 18: order.OrderService.GetOrderDetails:output_type -> order.GetOrderDetailsResponse
	13, // 19: order.OrderService.GetOrdersByUser:output_type -> order.GetOrdersByUserResponse
	11, // 20: order.OrderService.CompleteDelivery:output_type -> order.CompleteDeliveryResponse
	17, // 21: order.OrderService.GetDeliveries:output_type -> order.GetDeliveriesByUserResponse
	8,  // 22: order.OrderService.GetOrderItemPrice:output_type -> order.GetOrderItemPriceResponse
